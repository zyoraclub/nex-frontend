...
export default function GitLabCallback() {
  ...
  useEffect(() => {
    const handleCallback = async () => {
      ...
      const savedState = localStorage.getItem('gitlab_oauth_state');
      ...
      try {
        await integrationAPI.connectGitLab({
          integration_name: 'GitLab OAuth',
          access_token: token,
          repositories: []
        });
        ...
        setTimeout(() => navigate(`/${orgSlug}/integrations/gitlab-oauth`), 1000);
      } catch (err) {
